App = {
    ...
    initWeb3: async function () {
        ...
        if (window.ethereum) {
            console.log("Find or Inject Web3 Provider")
            ...
            try {
                ...
                App.metamaskAccountID = App.accounts[0]
        ...
        // If no injected web3 instance is detected, fall back to Ganache
            ...
            console.log("If no injected web3 instance is detected, fall back to Ganache")
            App.web3Provider = new Web3.providers.HttpProvider('http://172.0.0.1:8545');
        }
